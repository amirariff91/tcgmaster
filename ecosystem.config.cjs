...
module.exports = {
  apps: [
    ...
    // ─────────────────────────────────────────────
    {
      name: 'pop-scraper-psa',
      script: 'bun',
      args: 'run scripts/scrapers/pop/psa.ts',
      watch: false,
      autorestart: true,
      restart_delay: 15000,
      exp_backoff_restart_delay: 5000,
      max_restarts: 50,
      min_uptime: '30s',
      log_file: './logs/pop-scraper-psa.log',
      error_file: './logs/pop-scraper-psa-error.log',
      time: true,
    },
    {
      name: 'pop-scraper-bgs',
      script: 'bun',
      args: 'run scripts/scrapers/pop/bgs.ts',
      watch: false,
      autorestart: true,
      restart_delay: 15000,
      exp_backoff_restart_delay: 5000,
      max_restarts: 50,
      min_uptime: '30s',
      log_file: './logs/pop-scraper-bgs.log',
      error_file: './logs/pop-scraper-bgs-error.log',
      time: true,
    },
    {
      name: 'pop-scraper-cgc',
      script: 'bun',
      args: 'run scripts/scrapers/pop/cgc.ts',
      watch: false,
      autorestart: true,
      restart_delay: 15000,
      exp_backoff_restart_delay: 5000,
      max_restarts: 50,
      min_uptime: '30s',
      log_file: './logs/pop-scraper-cgc.log',
      error_file: './logs/pop-scraper-cgc-error.log',
      time: true,
    },
    {
      name: 'pop-scraper-tag',
      script: 'bun',
      args: 'run scripts/scrapers/pop/tag.ts',
      watch: false,
      autorestart: true,
      restart_delay: 15000,
      exp_backoff_restart_delay: 5000,
      max_restarts: 50,
      min_uptime: '30s',
      log_file: './logs/pop-scraper-tag.log',
      error_file: './logs/pop-scraper-tag-error.log',
      time: true,
    }
  ],
};
