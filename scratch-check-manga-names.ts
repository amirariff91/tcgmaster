...
async function main() {
  const MANGA_SLUGS = [
    ...
    'op-op16-073_p2-ja', 'op-op07-119_p2-ja', 'op-op07-109_p2-ja', 'op-op08-119_p2-ja',
    'op-op08-119_p3-ja', 'op-op08-069_p2-ja', 'op-eb01-001_p2-ja', 'op-eb01-061_p2-ja',
    'op-eb01-061_p3-ja', 'op-st01-012_p1-ja', 'op-st01-012_p2-ja', 'op-st10-006_p1-ja',
  ...
  for (const c of cards) {
    if (!c.name.toLowerCase().includes('manga')) {
      console.log(`NOT MANGA IN DB: ${c.slug} - ${c.name}`);
    }
  }
