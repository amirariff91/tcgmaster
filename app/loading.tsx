    ...
    <div aria-busy="true" aria-label="Loading" className="min-h-[60vh] w-full">
      ...
      <div className="border-b border-zinc-100 bg-zinc-50 px-4 py-10">
        <div className="mx-auto max-w-5xl space-y-4">
          <div className="h-8 w-56 animate-pulse rounded-md bg-zinc-200 dark:bg-zinc-700" />
          <div className="h-4 w-96 max-w-full animate-pulse rounded-md bg-zinc-100 dark:bg-zinc-800" />
          <div className="h-10 w-72 animate-pulse rounded-md bg-zinc-200 dark:bg-zinc-700" />
        </div>
      </div>

      {/* Card grid skeleton */}
      <div className="mx-auto max-w-5xl px-4 py-8">
        <div className="mb-6 h-6 w-32 animate-pulse rounded-md bg-zinc-200 dark:bg-zinc-700" />
